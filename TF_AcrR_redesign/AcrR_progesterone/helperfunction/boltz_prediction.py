...
def run_boltz_batch_prediction_sequentially(input_yaml_folder: str):
    ...
    for yaml_file in yaml_files:
        ...
        boltz_command = f"boltz predict {yaml_path}  --use_msa_server --recycling_steps 20 --output_format pdb --diffusion_samples 10"
        
        os.system(boltz_command)
        
if __name__ == "__main__":

    input_folder = "/home/hdwang/sensor_hd/protein_sensor_hd/AR_MBP_demo/timed_design/ligandmpnn_yaml/yaml4boltz_ligandmpnn"
